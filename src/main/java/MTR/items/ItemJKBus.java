...
public class ItemJKBus extends ItemSpawnTrain<EntityJKBus> {

	private static final String[] name = { "ItemJKBus11",};
	private static final String name2 = "ItemJKBus1";
	...
	@Override
	protected EntityJKBus createTrain(World worldIn, double x, double y, double z, boolean f, int h) {
		return new EntityJKBus(worldIn, x, y, z, f, h);
	}
